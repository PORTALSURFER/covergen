...
use crate::image_ops::{resolve_output_path, save_png_under_10mb};
use crate::telemetry;

use super::animation::clip_output_path;
...
pub async fn execute_compiled(
    ...
    if config.animation.enabled {
        return animation_exec::execute_animation(config, compiled, &mut renderer, &mut buffers);
    }
