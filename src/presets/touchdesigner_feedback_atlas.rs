//! TouchDesigner-style feedback atlas preset with staged masked reinjection.
...
/// Build a TouchDesigner-style feedback atlas graph with multiple tap outputs.
pub(super) fn build_td_feedback_atlas(ctx: PresetContext<'_>) -> Result<GpuGraph, GraphBuildError> {
