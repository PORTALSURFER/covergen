//! operator-family router preset with parallel lanes and routed tap outputs.
...
/// Build a router-style operator graph with explicit parallel lanes and routed outputs.
pub(super) fn build_operator_router(ctx: PresetContext<'_>) -> Result<GpuGraph, GraphBuildError> {
